...
public:
    ...
    Impl(float x, float y, float width, float height)
...
bool RoundedRectPrimitive::initialize() { return impl_->initialize(); }
void RoundedRectPrimitive::destroy() { impl_->destroy(); }
void RoundedRectPrimitive::setBounds(float x, float y, float width, float height) { impl_->setBounds(x, y, width, height); }
void RoundedRectPrimitive::setColor(const Color& color) { impl_->setColor(color); }
void RoundedRectPrimitive::setGradient(const Gradient& gradient) { impl_->setGradient(gradient); }
void RoundedRectPrimitive::setCornerRadius(float radius) { impl_->setCornerRadius(radius); }
void RoundedRectPrimitive::setOpacity(float opacity) { impl_->setOpacity(opacity); }
void RoundedRectPrimitive::setBorder(const Border& border) { impl_->setBorder(border); }
void RoundedRectPrimitive::setShadow(const Shadow& shadow) { impl_->setShadow(shadow); }
void RoundedRectPrimitive::setBlur(float blur) { impl_->setBlur(blur); }
void RoundedRectPrimitive::setTranslate(float x, float y) { impl_->setTranslate(x, y); }
void RoundedRectPrimitive::setScale(float x, float y) { impl_->setScale(x, y); }
void RoundedRectPrimitive::setRotate(float radians) { impl_->setRotate(radians); }
void RoundedRectPrimitive::setTransformOrigin(float x, float y) { impl_->setTransformOrigin(x, y); }
void RoundedRectPrimitive::setTransform(const Transform& transform) { impl_->setTransform(transform); }
void RoundedRectPrimitive::setTransformMatrix(const TransformMatrix& matrix) { impl_->setTransformMatrix(matrix); }
...
void RoundedRectPrimitive::render(int windowWidth, int windowHeight) const { impl_->render(windowWidth, windowHeight); }
...
bool PolygonPrimitive::initialize() { return impl_->initialize(); }
void PolygonPrimitive::destroy() { impl_->destroy(); }
void PolygonPrimitive::setBounds(float x, float y, float width, float height) { impl_->setBounds(x, y, width, height); }
void PolygonPrimitive::setPoints(const std::vector<Vec2>& points) { impl_->setPoints(points); }
void PolygonPrimitive::setColor(const Color& color) { impl_->setColor(color); }
void PolygonPrimitive::setOpacity(float opacity) { impl_->setOpacity(opacity); }
void PolygonPrimitive::setTransform(const Transform& transform) { impl_->setTransform(transform); }
void PolygonPrimitive::setTransformMatrix(const TransformMatrix& matrix) { impl_->setTransformMatrix(matrix); }
void PolygonPrimitive::render(int windowWidth, int windowHeight) const { impl_->render(windowWidth, windowHeight); }
